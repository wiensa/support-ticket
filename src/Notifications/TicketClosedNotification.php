...
class TicketClosedNotification extends Notification implements ShouldQueue
{
    ...
    {
        return config('supportticket.notifications.ticket_closed.channels', ['mail']);
    }
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject(__('supportticket::notifications.ticket_closed_subject', ['id' => $this->ticket->id]))
            ->greeting(__('supportticket::notifications.greeting'))
            ->line(__('supportticket::notifications.ticket_closed_line1'))
            ...
            ->line(__('supportticket::notifications.ticket_closed_reopen'))
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'message' => __('supportticket::notifications.ticket_closed_database_message'),
        ];
    }
} 